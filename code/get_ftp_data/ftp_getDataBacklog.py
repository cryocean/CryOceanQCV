"""
Program: copy of ftp_getDataLatency.py
Author: Chris Banks
Last date modified: 10 Jan 2017
...
by creating new directories if needed. 
Does exactly the same as the original just polulates the datasets from Nov 2010 until 

It checks for missing files or existing
...
#data_sets = ('SIR_FDM_L2/2015','SIR_IOP_L2/2015','SIR_GOP_L2/2015')
