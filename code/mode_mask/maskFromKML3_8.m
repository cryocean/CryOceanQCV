...
fn = dir([dir1 'Mask*8.kml']);
modes = load([dir1 'zonesNameMode_3_8.mat']); % this file needs to be created before running the script
modes = modes.Z;
...
save seasMask_noLRM_3_8.mat seasMask -mat
