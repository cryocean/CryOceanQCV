...
"""
# copy of get_EN4_data.py that donloads 2013 data - can be edited to provide other years for catchup, may need to tweak dateEN4
import gzip
import re
import os
import scipy as sp
...
#     path_EN4 = "/scratch/general/cryosat/validation_data_2/EN4_TS_profiles/" #path where data are saved
    ...
    yearEN4 = '2013' #yearEN4[7][0:4] # year of most recent data
