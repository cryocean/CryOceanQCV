# Version of update.py but will work for Test Data Set (May 2017) and catchup repreocessed data
# NB dates for WW3 data hardcoded in getWW3DataCATCHUP.m
...
from get_EN4_data2013 import getEN4Data #T/S data from EN4 dataset
...
def main():
    ...
    getSlData()
    getSwhWspData() # added folders to /noc/mpoc/cryo/cryosat/validation_data_2/buoys
    getCwspData()  # added folders to /noc/mpoc/cryo/cryosat/validation_data_2/buoys
    cmd_ww3 = """%s -nodisplay -nosplash -nodesktop -r "cd %s; getWW3DataCATCHUP; quit" """\
