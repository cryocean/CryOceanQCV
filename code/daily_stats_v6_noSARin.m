function daily_stats_v6_noSARin(day_date,data_type,path1,path2,path3,mss,gshhs,ground)
...
% this version comments out all details relating to SARin to provide quick
% fix for TDS work May 2017, Chris Banks
%
%% load data
...
if strcmp(data_type,'SIR_GOP_L2')
    save([path_val 'dataVal_' data_type2 '_' day_date '.mat'],'-struct','dataVal')
end
