...
% This bit just defines the name of the v1 variable
% (first colum) and the v2 variable (second colum) that it
% is mapped to
% First the 1Hz data - doubles are just copied
% NOTE WET TROP IS ********NOT********** GPD+
v.v_01_dbl = struct(...
  'time',                         'time_01',...
  'utc_time',                     'time_01',...
  'time_offset',                  '',...
...
% This now runs over all teh v1 variables and finds the v2 variable name in the data structure read from the v2 file
